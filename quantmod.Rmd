...
```{r message=TRUE}
  ...
  ls(envir = new.environment)
  head(pander::pander(new.environment[["000300.SS"]],split.cells =3),5)
```
...
```{r}
chartSeries(AAPL,name = "AAPLCHART",subset = "013-10-01::2013-10-23")

chartSeries(AAPL,name = "AAPLCHART",subset = "013-10-01::2013-10-23",theme = "white")

#适合印刷
chartSeries(AAPL,name = "AAPLCHART",subset = "2013-10-01::2013-10-23",theme = "white.mono")

chart_Series(AAPL,type = "auto")
chart_Series(AAPL,type = "candlesticks")
chart_Series(AAPL,type = "bar")
chart_Series(AAPL,type = "line")
chart_Series(AAPL,type = "matchsticks")
